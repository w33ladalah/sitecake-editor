...
public class ListItemImplStandard extends ListItem {
	...
	ListItemImplStandard() {
		super();
	}

	ListItemImplStandard(Element element) {
		super(element);
	}

	public ListItemImplStandard(String htmlText, String style,
			boolean defaultContent) {
		super(htmlText, style, defaultContent);
	}

	public ListItemImplStandard(String htmlText, String style) {
		super(htmlText, style);
	}

	@Override
	public ContentItem cloneItem() {
		ListItemImplStandard clone = new ListItemImplStandard(htmlText, style);
	...
	protected native void setupPasteHandler()/*-{
		...
		element.onpaste = function(e) {
			self.@com.sitecake.contentmanager.client.item.list.ListItemImplStandard::onPaste()();
		};
	}-*/;
