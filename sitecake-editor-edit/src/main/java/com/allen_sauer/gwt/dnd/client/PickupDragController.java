 ...
 */
/*
 * Nikola: movablePanel changed to protected
 */
...
public class PickupDragController extends AbstractDragController {
  ...
  private final ArrayList<DropController> prioDropControllerList = new ArrayList<DropController>();
  ...
  public PickupDragController(AbsolutePanel boundaryPanel, boolean allowDroppingOnBoundaryPanel) {
    ...
    dropControllerCollection = new DropControllerCollection(dropControllerList, prioDropControllerList);
  }
  ...
  /**
   * Register a new priority DropController.
   * 
   * @param dropController the controller to register
   */
  public void registerPriorityDropController(DropController dropController) {
	  prioDropControllerList.add(dropController);
  }
  ...
  public void unregisterDropController(DropController dropController) {
    ...
    prioDropControllerList.remove(dropController);
  }
